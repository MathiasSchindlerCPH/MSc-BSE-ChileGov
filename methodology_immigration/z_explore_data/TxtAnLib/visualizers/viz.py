...
def pday_hashtags(DF: pd.DataFrame, list_of_hashtags: list):
    ...
    df_1 = DF.copy()
    df_1['created_at']=df_1['created_at'].astype(str)
    df_1['tweet_hashtags']=df_1['tweet_hashtags'].astype(str)
...
def popular_tweets(DF: pd.DataFrame, metric = "Retweets", number = 10):
    '''
    ...
    '''
    if metric == "Likes":
        df_1 = DF.sort_values(by = ['public_metrics.like_count'],ascending = False).copy()
    ...
    if metric == "Retweets":
        df_1 = DF.sort_values(by = ['public_metrics.retweet_count'],ascending = False).copy()
        for i in range(0,number):
            print(df_1['text'].iloc[i])
            print("Author: " + str(df_1['author.username'].iloc[i]))
            print("RT: " + str(df_1['public_metrics.retweet_count'].iloc[i]))
    ...
    if metric == "Quotes":
        df_1 = DF.sort_values(by = ['public_metrics.quote_count'],ascending = False).copy()
        for i in range(0,number):
            print(df_1['text'].iloc[i])
            print("Author: " + str(df_1['author.username'].iloc[i]))
            print("RT: " + str(df_1['public_metrics.retweet_count'].iloc[i]))
    ...
    if metric == "Replies":
        df_1 = DF.sort_values(by = ['public_metrics.reply_count'],ascending = False).copy()
        for i in range(0,number):
            print(df_1['text'].iloc[i])
            print("Author: " + str(df_1['author.username'].iloc[i]))
            print("RT: " + str(df_1['public_metrics.retweet_count'].iloc[i]))
